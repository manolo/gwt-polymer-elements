...
public interface PlatinumSwFetchElement extends HTMLElement {

    @JsOverlay public static final String TAG = "platinum-sw-fetch";
     ...
     * 
     */
    @JsProperty void setHandler(String value);
     ...
     * 
     */
    @JsProperty void setOrigin(String value);
