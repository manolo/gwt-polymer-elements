...
/**
 * <p><code>&lt;slide-from-bottom-animation&gt;</code> animates the transform of an element from <code>none</code> to <code>translateY(100%)</code>.<br>The <code>transformOrigin</code> defaults to <code>50% 0</code>.</p>
 * <p>Configuration:</p>
 * <pre><code>{
 ...
 * </code></pre>
 */
public class SlideFromBottomAnimation extends PolymerWidget {
    /**
     * Default Constructor.
     */
    public SlideFromBottomAnimation() {
       this("");
    }
     ...
     */
    public SlideFromBottomAnimation(String html) {
        super(SlideFromBottomAnimationElement.TAG, SlideFromBottomAnimationElement.SRC, html);
    }

    /**
     * Gets a handle to the Polymer object's underlying DOM element.
     */
    public SlideFromBottomAnimationElement getPolymerElement() {
        return (SlideFromBottomAnimationElement) getElement();
    }
