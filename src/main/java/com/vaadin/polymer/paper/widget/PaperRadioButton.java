...
public class PaperRadioButton extends PolymerWidget {
     ...
     * 
     */
    public JavaScriptObject getAriaActiveAttribute(){
     ...
     * 
     */
    public void setAriaActiveAttribute(JavaScriptObject value) {
     ...
     *
     * JavaScript Info:
     * @attribute aria-active-attribute
     * 
     */
    public void setAriaActiveAttribute(String value) {
        getPolymerElement().setAttribute("aria-active-attribute", value);
    }
