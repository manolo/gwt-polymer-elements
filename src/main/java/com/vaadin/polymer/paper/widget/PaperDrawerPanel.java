 ...
 * 
 * 
 * </code></pre><p>Styling paper-drawer-panel:</p>
 * <p>To change the main container:<br>  paper-drawer-panel {<br>    —paper-drawer-panel-main-container: {<br>      background-color: gray;<br>    };<br>  }</p>
 * <p>To change the drawer container when it’s in the left side:<br>  paper-drawer-panel {<br>    —paper-drawer-panel-left-drawer-container: {<br>      background-color: white;<br>    };<br>  }</p>
 * <p>To change the drawer container when it’s in the right side:</p>
 * <p>  paper-drawer-panel {<br>    —paper-drawer-panel-right-drawer-container: {<br>      background-color: white;<br>    };<br>  }</p>
 */
