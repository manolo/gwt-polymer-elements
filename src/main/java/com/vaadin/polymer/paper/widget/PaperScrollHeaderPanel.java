...
public class PaperScrollHeaderPanel extends PolymerWidget {
     ...
     * 
     */
    public double getHEADER_STATE_CONDENSED(){
        return getPolymerElement().getHEADER_STATE_CONDENSED();
    }
    /**
     * <p>The header’s state when it’s condensed.</p>
     *
     ...
     * 
     */
    public void setHEADER_STATE_CONDENSED(double value) {
        getPolymerElement().setHEADER_STATE_CONDENSED(value);
    }
     ...
     * 
     */
    public double getHEADER_STATE_EXPANDED(){
        return getPolymerElement().getHEADER_STATE_EXPANDED();
    }
    /**
     * <p>The header’s initial state</p>
     *
     ...
     * 
     */
    public void setHEADER_STATE_EXPANDED(double value) {
        getPolymerElement().setHEADER_STATE_EXPANDED(value);
    }
     ...
     * 
     */
    public double getHEADER_STATE_HIDDEN(){
        return getPolymerElement().getHEADER_STATE_HIDDEN();
    }
    /**
     * <p>The header’s state when it’s hidden.</p>
     *
     ...
     * 
     */
    public void setHEADER_STATE_HIDDEN(double value) {
        getPolymerElement().setHEADER_STATE_HIDDEN(value);
    }
     ...
     * 
     */
    public double getHEADER_STATE_INTERPOLATED(){
        return getPolymerElement().getHEADER_STATE_INTERPOLATED();
    }
    /**
     * <p>The header’s state when its progress is somewhere between<br>the <code>hidden</code> and <code>condensed</code> state.</p>
     *
     ...
     * 
     */
    public void setHEADER_STATE_INTERPOLATED(double value) {
        getPolymerElement().setHEADER_STATE_INTERPOLATED(value);
    }
