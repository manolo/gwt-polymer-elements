 ...
 * <ul>
 * <li><p><code>value.*</code> is observed, and saved on modifications. You must use<br>path change notification methods such as <code>set()</code> to modify value<br>for changes to be observed.</p>
 * </li>
