 ...
 * <ul>
 * <li><p><code>value.*</code> is observed, and saved on modifications. You must use<br>path change notifification methods such as <code>set()</code> to modify value<br>for changes to be observed.</p>
 * </li>
...
public interface IronLocalstorageElement extends HTMLElement {
    ...
    @JsOverlay public static final String TAG = "iron-localstorage";
    @JsOverlay public static final String SRC = "iron-localstorage/iron-localstorage.html";
    ...
    /**
     * <p>Saves the value to localStorage. Call to save if autoSaveDisabled is set.<br>If <code>value</code> is null or undefined, deletes localStorage.</p>
     *
     * JavaScript Info:
     * @method save
     * 
