...
public interface IronPageUrlElement extends HTMLElement {

    @JsOverlay public static final String TAG = "iron-page-url";
    @JsOverlay public static final String SRC = "iron-page-url/iron-page-url.html";
