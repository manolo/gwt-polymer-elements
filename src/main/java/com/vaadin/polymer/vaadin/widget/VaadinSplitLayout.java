...
public class VaadinSplitLayout extends PolymerWidget {
     ...
     */
    public VaadinSplitLayout(String html) {
        super(VaadinSplitLayoutElement.TAG, VaadinSplitLayoutElement.SRC, html);
    }
    ...
    public VaadinSplitLayoutElement getPolymerElement() {
        return (VaadinSplitLayoutElement) getElement();
    }
    ...
    public void setVertical(boolean value) {
        getPolymerElement().setVertical(value);
    }
     ...
     * @event iron-resize
     */
    public HandlerRegistration addIronResizeHandler(IronResizeEventHandler handler) {
        return addDomHandler(handler, IronResizeEvent.TYPE);
    }
