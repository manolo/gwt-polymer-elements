...
public interface ItemsFunction {
    ...
    @JsOverlay public static final String NAME = "ItemsFunction";
     ...
     * <p>See the API documentation for the <code>sortOrder</code> property and the<br><code>SortOrder</code> object for more details.</p>
     *
     * JavaScript Info:
     * @property sortOrder
