 ...
 * </code></pre>
 */
public class SlideDownAnimation extends PolymerWidget {
    /**
     * Default Constructor.
     */
     ...
     */
    public SlideDownAnimation(String html) {
        super(SlideDownAnimationElement.TAG, SlideDownAnimationElement.SRC, html);
     ...
     */
    public SlideDownAnimationElement getPolymerElement() {
        return (SlideDownAnimationElement) getElement();
    }
