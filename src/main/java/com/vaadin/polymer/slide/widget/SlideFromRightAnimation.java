...
/**
 * <p><code>&lt;slide-from-right-animation&gt;</code> animates the transform of an element from<br><code>translateX(100%)</code> to <code>none</code>.<br>The <code>transformOrigin</code> defaults to <code>0 50%</code>.</p>
 * <p>Configuration:</p>
 * <pre><code>{
 ...
 * </code></pre>
 */
public class SlideFromRightAnimation extends PolymerWidget {
    /**
     * Default Constructor.
     */
    public SlideFromRightAnimation() {
       this("");
    }
     ...
     */
    public SlideFromRightAnimation(String html) {
        super(SlideFromRightAnimationElement.TAG, SlideFromRightAnimationElement.SRC, html);
     ...
     */
    public SlideFromRightAnimationElement getPolymerElement() {
        return (SlideFromRightAnimationElement) getElement();
    }
